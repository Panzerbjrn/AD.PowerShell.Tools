...
<#
	...
	.EXAMPLE
		Reset-BDADUserPasswordTopassw0rd -User Petersson_L -Password "S@nd3r4lle123!!V4d£r"

		This will reset the user's password, and not force the user to change the password

	.EXAMPLE
		Reset-BDADUserPasswordTopassw0rd -User Peter* -Password "S@nd3r4lle123!!V4d£r" -ChangePasswordAtLogon
