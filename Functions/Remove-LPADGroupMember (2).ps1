...
<#
	...
	.EXAMPLE
		Remove-BDADGroupMember -GroupName "Stale - Local Server Administrators - DU-SCCM-DP02"
#>
	[CmdletBinding()]
	PARAM (
		[Parameter(Mandatory=$True)][string]$GroupName
	)
	$Group = Get-BDADGroup -Group $GroupName

	$Members = Get-ADGroupMember -Identity $Group.SamAccountName | Sort-Object
	$menu = @{}
