...
<#
	...
	.EXAMPLE
		Remove-BDADUserFromGroup -User Petersson_L
...
Param(
	...
	$ADUser = Get-BDADUser -User $User

	$Groups = Get-ADPrincipalGroupMembership -Identity $ADUser.SamAccountName | Sort-Object
	$menu = @{}
